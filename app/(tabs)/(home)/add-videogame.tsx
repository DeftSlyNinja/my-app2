                ...
                >
                    {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
                        <Box>
                            ...
                            <Box className='mb-4'>
                                <Text size='lg' className='mb-2 text-stone-900 dark:text-white'>Genre</Text>
                                <Input variant='outline' size='md' className='bg-white dark:bg-zinc-900 mt-2'>
                                    <InputField 
                                ...
                                {touched.genre && errors.genre && (
                                    <Text size='sm' className='text-red-500 mt-1'>{errors.genre}</Text>
                                )}
                            </Box>
                            ...
                            >
                                ...
                                <CheckboxLabel className="text-stone-900 dark:text-white">Completed</CheckboxLabel>
                            </Checkbox>
                            {touched.completed && errors.completed && (
                                <Text size='sm' className='text-red-500 mt-1'>{errors.completed}</Text>
                            )}
